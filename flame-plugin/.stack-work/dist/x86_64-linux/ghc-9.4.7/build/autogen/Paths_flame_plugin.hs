...
getDynLibDir  = catchIO (getEnv "flame_plugin_dynlibdir")  (\_ -> return dynlibdir)
getDataDir    = catchIO (getEnv "flame_plugin_datadir")    (\_ -> return datadir)
getLibexecDir = catchIO (getEnv "flame_plugin_libexecdir") (\_ -> return libexecdir)
getSysconfDir = catchIO (getEnv "flame_plugin_sysconfdir") (\_ -> return sysconfdir)
